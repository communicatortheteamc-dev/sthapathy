...
const graduation_transparentIcon = "/icons/graduation_transparent.png";
const books_transparentIcon = "/icons/books_transparent.png";
const earth_transparentIcon = "/icons/earth_transparent.png";
const temple_transparentIcon = "/icons/temple_transparent.png";
const mic_transparentIcon = "/icons/mic_transparent.png";
...
const Home = () => {
  ...
  interface ObjectiveCardProps {
    ...
    description?: string;
    active?: boolean;
    icon?: string; // new prop
  }

  const ObjectiveCard = ({ title, description, active, icon }: ObjectiveCardProps) => (
    <div
        ...
        <div className="flex items-center gap-3">
          {icon && (
            <img
              src={icon}
              alt={title}
              className="w-10 h-10 object-contain flex-shrink-0 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]"
            />
          )}
          <h4
            ...
            <div className="text-[#f5f5f5] space-y-6 px-2 sm:px-0 text-center md:text-left">
              ...
              <div className="pt-4 space-y-4 text-[#F5F5F5]">
                <ObjectiveCard
                  ...
                  active
                />
                <ObjectiveCard icon={scroll_transparentIcon} title="Research & Revive Sthapathya Veda" />
                <ObjectiveCard icon={graduation_transparentIcon} title="Train Architects & Sculptors" />
                <ObjectiveCard icon={books_transparentIcon} title="Publish Books & Journals" />
                <ObjectiveCard icon={earth_transparentIcon} title="Collaborate with Universities & Temples" />
                <ObjectiveCard icon={temple_transparentIcon} title="Conserve Ancient Temples" />
                <ObjectiveCard icon={mic_transparentIcon} title="Organize Seminars & Exhibitions" />
                <ObjectiveCard icon={pray_transparentIcon} title="Empower Artisans" />
